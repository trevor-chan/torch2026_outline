...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--val-interval", type=int, default=5_000, help="set 0 to disable")
    parser.add_argument("--sample-interval", type=int, default=5_000, help="set 0 to disable")
    parser.add_argument("--checkpoint-interval", type=int, default=5_000, help="set 0 to save only at normal exit")
